...
export default function UserViewDiliveryDetailsProfile() {
  ...
  const handleViewLocation = (deliveryAddress) => {
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        (position) => {
          ...
          const mapsUrl = `https://www.google.com/maps/dir/?api=1&origin=${userLat},${userLng}&destination=${encodedDeliveryAddress}&travelmode=driving`;
