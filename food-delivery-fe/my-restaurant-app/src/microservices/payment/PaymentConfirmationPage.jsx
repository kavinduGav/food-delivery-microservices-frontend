...
import { Result, Button, Spin, Card, Alert, Typography } from 'antd';
      ...
      <div className="payment-confirmation">
        <Card className="confirmation-card">
          ...
          <Alert
            ...
            description="We've sent a confirmation email with all the order details to your registered email address."
            type="info"
            showIcon
